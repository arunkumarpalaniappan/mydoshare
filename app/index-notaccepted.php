...
if($_SESSION["user"]!="")
{
   ...
   $check ="SELECT * FROM _doshare_groups WHERE email='$myinfo'";
     ...
     if($result->num_rows > 0){
      while($row = $result->fetch_assoc()){
        if($row["groupn"]!="needtobeapproved")
        {
              ...
              <div class="box">
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div align="center">
                        <p style="font-family: 'Roboto Condensed', sans-serif;font-size:15px;">Your request to join the sharegroup has been sent to the group members, we send send you an email once the request is approved.</p><br>               
                      </div>
                      <br>                      
                    </div>
                  </div>
