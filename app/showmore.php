...
?>
    ...
    <title>Bills and IOU's | mydoShare</title>
                                                            ...
                                                            for($i = 0; $i < $max;$i++)
                                                                {
                                                                    $getrv = $names[$i];
                                                                    ?>
                                                           <td style="padding:10px;color:green;" ><?php if($getr[$getrv]==0) {echo '-';}else{echo "&#8377;".$getr[$getrv];}?></td>
                                                           <?php
                                                                }
                                                                ?>
                                                                    </tr>
                                                            ...
                                                            for($i = 0; $i < $max;$i++)
                                                                {
                                                                    ...
                                                                    ?>
                                                           <td style="padding:10px;color:red;" ><?php if($getr[$getrv]==0) {echo '-';}else{echo "&#8377;".$getr[$getrv];}?></td>
                                                        <?php
                                                                }
                                                                ?>
                                                            </tr>
